...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'waddle', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '摸鱼中🐟', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.waddle.top', // 网站地址
  ...
  CONTACT_WEHCHAT_PUBLIC: process.env.NEXT_PUBLIC_CONTACT_WEHCHAT_PUBLIC || 'https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzkxNzYyMjcyMg==', // 微信公众号 格式：https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=【xxxxxx】==#wechat_redirect
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-RLB8WQJD85', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
